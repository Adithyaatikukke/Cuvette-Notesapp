...
const DNotes = ({ notes, setNotes, selected, setSelected }) => {
	...
	return (
		<div className="dnotes">
			<div className="dnotes_title">
				<div
					className="dnotes_title_color"
					style={{ backgroundColor: bgColor }}
				>
					{initials}
				</div>
				<div className="dnotes_title_text">{selectedTitle}</div>
			</div>
			<div className="dnotes_content">
				{notes.length === 0
					? null
